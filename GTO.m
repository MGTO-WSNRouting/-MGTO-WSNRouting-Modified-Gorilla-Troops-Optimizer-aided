function [Silverback_Score,Silverback,convergence_curve,time]=GTO(X,fobj,lb,ub,max_iter)
% initialize Silverback    SFO(Plants, Fun, LB, UB, n_iter)
Silverback=[];
...
[pop_size,variables_no] = size(X);
for i=1:pop_size   
    Pop_Fit(i)=feval(fobj,(X(i,:)));%#ok
